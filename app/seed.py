...
CARDS = [
    ...
    ("46ca0b66-a000-4483-b916-f5b89e710244", "6ad8011d-3471-4369-9d68-b264cc027487", "Sol Ring", "cmm", "Commander Masters", "410", "en", "uncommon", "https://cards.scryfall.io/normal/front/4/6/46ca0b66-a000-4483-b916-f5b89e710244.jpg"),
    ("e768c957-3a1f-42f5-853a-96942f645df5", "4457ed35-7c10-48c8-9776-456485fdf070", "Lightning Bolt", "m11", "Magic 2011", "149", "en", "common", "https://cards.scryfall.io/normal/front/e/7/e768c957-3a1f-42f5-853a-96942f645df5.jpg"),
    ("1920dae4-fb92-4f19-ae4b-eb3276b8dac7", "cc187110-1148-4090-bbb8-e205694a39f5", "Counterspell", "mh2", "Modern Horizons 2", "267", "en", "uncommon", "https://cards.scryfall.io/normal/front/1/9/1920dae4-fb92-4f19-ae4b-eb3276b8dac7.jpg"),
    ("581b7327-3215-4a4f-b4ae-d9d4002ba882", "68954295-54e3-4303-a6bc-fc4547a4e3a3", "Llanowar Elves", "dom", "Dominaria", "168", "en", "common", "https://cards.scryfall.io/normal/front/5/8/581b7327-3215-4a4f-b4ae-d9d4002ba882.jpg"),
    ("4d3473d0-b46f-41f5-ac1e-ba217f7747d4", "358789f9-7d87-411d-919e-d597da665cbd", "Stoneforge Mystic", "2xm", "Double Masters", "31", "en", "rare", "https://cards.scryfall.io/normal/front/4/d/4d3473d0-b46f-41f5-ac1e-ba217f7747d4.jpg"),
    ("6fc57076-cac4-4f5e-956b-e3d77bd258b2", "53f7c868-b03e-4fc2-8dcf-a75bbfa3272b", "Dark Ritual", "sta", "Strixhaven Mystical Archive", "26", "en", "rare", "https://cards.scryfall.io/normal/front/6/f/6fc57076-cac4-4f5e-956b-e3d77bd258b2.jpg"),
    ("b281a308-ab6b-47b6-bec7-632c9aaecede", "edd8d1e8-be43-4c38-bb3a-83081fbaf0b5", "Thoughtseize", "2xm", "Double Masters", "109", "en", "rare", "https://cards.scryfall.io/normal/front/b/2/b281a308-ab6b-47b6-bec7-632c9aaecede.jpg"),
    ("3d69a3e0-6a2e-475a-964e-0affed1c017d", "d3a0b660-358c-41bd-9cd2-41fbf3491b1a", "Birds of Paradise", "rvr", "Ravnica Remastered", "133", "en", "rare", "https://cards.scryfall.io/normal/front/3/d/3d69a3e0-6a2e-475a-964e-0affed1c017d.jpg"),
    ("043b2d30-a40f-4d47-933b-80544512f9c2", "53236dd7-845a-444c-96d5-f41ed7325d8f", "Rhystic Study", "wot", "Wilds of Eldraine: Enchanting Tales", "25", "en", "mythic", "https://cards.scryfall.io/normal/front/0/4/043b2d30-a40f-4d47-933b-80544512f9c2.jpg"),
...
LISTINGS = [
    ...
    (3, 4, "Counterspell MH2", "Aceito venda ou troca local.", 900, "NM", "en", "ambos"),
    (4, 5, "Llanowar Elves", "Ótima para completar o deck.", 350, "SP", "en", "venda"),
    ...
    try:
        ...
        conn.executemany(
            """INSERT INTO cards(scryfall_id,oracle_id,name,set_code,set_name,collector_number,language,rarity,image_url)
               VALUES (?,?,?,?,?,?,?,?,?)
               ON CONFLICT(scryfall_id) DO UPDATE SET name=excluded.name,set_code=excluded.set_code,
        ...
        for lid, pos, title, desc, price, condition, language, mode in LISTINGS:
            conn.execute(
                """INSERT INTO listings(id,card_id,user_id,title,description,price_cents,condition,language,mode,contact_url)
                   VALUES (?,?,?,?,?,?,?,?,?,?)
                   ON CONFLICT(id) DO UPDATE SET card_id=excluded.card_id,user_id=excluded.user_id,
